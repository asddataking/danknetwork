...
export default function FeaturedEpisodeHero({ episode }: FeaturedEpisodeHeroProps) {
  ...
  return (
    <>
      <div 
        className="relative w-full aspect-video sm:aspect-[16/9] md:aspect-[21/9] rounded-lg overflow-hidden border border-neon-green/30 group cursor-pointer"
      ...
      <div className="relative z-10 h-full flex flex-col justify-end p-4 sm:p-6 md:p-8 lg:p-10">
        ...
        {/* Title */}
        <h1 className="text-white font-black text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl mb-3 sm:mb-4 uppercase leading-tight">
          {episode.title}
        </h1>

        {/* Metadata */}
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 md:gap-4 text-xs sm:text-sm text-gray-300 mb-4 sm:mb-6">
        ...
        <button
          ...
          className="bg-neon-green text-black px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-bold text-base sm:text-lg uppercase hover:bg-neon-green-dark transition-colors duration-200 w-fit"
        >
          Watch Now
        </button>
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
        <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center group-hover:scale-110 group-hover:bg-white/30 transition-all duration-300 glow-neon-green">

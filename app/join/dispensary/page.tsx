...
export default function DispensaryOnboardingPage() {
  const { user } = useAuth();
      ...
      <div className="px-6 pt-16 pb-24">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-2xl font-bold text-brand-ink">Dispensary Application</h1>
              <p className="text-brand-subtle">Join Dank Network as a dispensary partner</p>
            </div>
          </div>
          ...
          {step === 1 && (
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-brand-ink mb-2">Business Name *</label>
                  <input
                    type="text"
